...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'sc': {
                m.reply('Script : https://github.com/JimmmssssPM\n\n Dont Forget Give Star\n\nDonate : 6289637869297 (Link Aja)\nDana : 6289637869297 \nOVO : 6289637869297 \nGopay : 6289637869297 \n\n Dont Forget Donate')
            }
            break
            case 'chat': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/JimmmssssPM'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 896-3786-9297'
                                }
                            }, {
                                quickReplyButton: {
                      ...
                      fatihgans = fs.readFileSync('./lib/hisoka.jpeg')
...
│
└───────⭓`
                let message = await prepareWAMessageMedia({ image: fs.readFileSync('./lib/hisoka.jpeg') }, { upload: hisoka.waUploadToServer })
